...
const ICONS = {
  ...
  heart:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20s-6.5-4.3-9-8.3C1.4 9 2.3 5.8 5.2 5.1 7 4.7 8.8 5.4 12 8.4c3.2-3 5-3.7 6.8-3.3 2.9.7 3.8 3.9 2.2 6.6-2.5 4-9 8.3-9 8.3z"/><path d="M12 8.4c0 0 .3 4 0 8" opacity=".35"/></svg>',
  mountain:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M3 19h18L14.5 7l-3.2 5.4-2-2.6L3 19z"/><path d="M12.4 9.2l2.1-2.2" opacity=".5"/></svg>',
