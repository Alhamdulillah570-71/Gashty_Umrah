  ...
  return topbar({title:c.title})
    +'<div class="screen view">'
      ...
      +'<div class="q-card">'
        ...
        +(shown
            ? '<div class="q-answer"><div class="qa-label">وەڵام</div><div class="qa-text">'+esc(q.a)+'</div>'
                + (q.e ? '<div class="qa-label qa-exp-label">ڕوونکردنەوە</div><div class="qa-text qa-exp">'+esc(q.e)+'</div>' : '')
              +'</div>'
